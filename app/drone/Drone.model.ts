export type DroneObstacle = {x: number; y: number; z: number; width: number; height: number; depth: number; isWall: boolean}
...
//     algorithm: "A2C",
//     actorNetworkSize: 128,
//     valueNetworkSize: 128,
//     episodesPerUpdate: 3,
//     batchSize: 512,
//     numBatchesPerUpdate: 4,
//     learningRate: 5e-4,
...
//     goalThresholdDistance: 1,
//     goalReward: 100,
//     hitObstaclePenalty: -5,
//     distancePenalty: -1,
//     directionReward: .01,
//     proximitySensorPenalty: -10,
// }